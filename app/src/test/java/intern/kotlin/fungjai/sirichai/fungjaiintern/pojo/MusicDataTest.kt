...
class MusicDataTest {
    ...
    fun descriptionGetSetTest() {
        ...
        assertEquals("Fungjaizine ขอเชิญทุกท่านมาทำความรู้จัก แก้ว และ ตาหวาน 2 สมาชิกจากแก๊งชราไลน์แห่ง BNK48 กับเรื่องราวการไปเล่นดนตรีที่ญี่ปุ่นและชีวิตที่ทั้งคู่ไม่เคยเปิดเผยที่ไหนมาก่อน", description.description)
    }

    @Test
    fun titleGetSetTest() {
        val title = MusicData(null, null, null, null, null, "แก้วตาหวานใจ : Playlist เพลงโปรดของ แก้ว และ ตาหวาน BNK48", null)
        assertEquals("แก้วตาหวานใจ : Playlist เพลงโปรดของ แก้ว และ ตาหวาน BNK48", title.title)
    }

    @Test
    fun urlGetSetTest() {
        val url = MusicData(null, null, null, null, null, null, "https://www.fungjaizine.com/feature/my_ears/kaew-tawaan-bnk48")
        assertEquals("https://www.fungjaizine.com/feature/my_ears/kaew-tawaan-bnk48", url.url)
    }
}